...
*/
  ...
  private void doPenetration(String ip, int port) {
    try {
      ...
      new Thread() {
        public void run() {
          try {
            ...
            newsocket.bind(
                new InetSocketAddress(InetAddress.getLocalHost().getHostAddress(), localPort));
      ...
      //
      //			System.out.println("成功了，哈哈，新的连接：" + st.getInetAddress().getHostAddress() + ":" +
      // st.getPort());
      //
      //			serverSocket.close();
    } catch (Exception e) {
